...
class Trap {
    constructor(lseg = 0, rseg = 0, hi = new Point(), lo = new Point(), u0 = 0, u1 = 0, d0 = 0, d1 = 0, sink = 0, uSave = 0, uSide = 0, state = 0) {
        this.lseg = lseg;
        this.rseg = rseg;
        this.hi = hi;
        this.lo = lo;
...
class NodeT {
    constructor(nodeType = nType.T_SINK, segnum = 0, yVal = new Point(), trNum = 0, paren = 0, left = 0, right = 0) {
